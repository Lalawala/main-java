...
public interface Board {
	...
	interface TicketBoard {
		/**
		 * @param ticket the ticket to check count for//players' tickets consumption
	...
	/**
	 * @return the current game setup//get__ read and return; 读对象的数据；set__ 改数据
	 *
	 */
